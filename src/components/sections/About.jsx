...
//                 {/* Replace 'your-image-name.png' with the actual file name in your public/images folder */}
//                 <img 
//                   src="/images/about-img.png" 
//                   alt="Lexa Technologies Team" 
//                   className="about-hero-main-img" 
//                 />
                
//                 {/* Floating aesthetic elements */}
//                 <div className="hero-float-badge badge-top">
//                   <FaRocket className="text-blue" /> <span>Innovation First</span>
//                 </div>
//                 <div className="hero-float-badge badge-bottom">
//                   <FaCode className="text-green" /> <span>Delivery Focused</span>
//                 </div>
//               </div>
//             </div>
          ...
          <div className="hero-split-grid">
            ...
            <div className="hero-image-col">
              <div className="about-hero-img-wrapper">
                ...
                {/* Your hero image (ensure this exists in public/images) */}
                <img 
                  src="/images/about-img.png" 
                  alt="Lexa Technologies Team" 
                  className="about-hero-main-img" 
