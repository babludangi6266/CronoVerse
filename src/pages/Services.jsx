...
import { 
  FaLaptopCode, FaMobileAlt, FaCloud, FaBrain, FaPaintBrush, FaBuilding, 
  FaPlus, FaMinus, FaRocket, FaCheckCircle, 
  ...
  const services = [
    {
      ...
      tagline: "White-Label. Delivered in 7 Days.",
      desc: "Enterprise-grade operational software customized to your brand. Stop paying monthly SaaS fees and own your data. We build scalable workforce management, client pipelines, and internal chat portals.",
      features: ["White-Label Branding", "7-Day Deployment", "No Monthly SaaS Fees", "Enterprise Security"],
      icon: <FaBuilding />,
      img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      gradient: "blue",
      path: "/services/crm-erp" // <-- Added route path
    },
    {
      id: "ai",
            ...
            >
              ...
              <div className="srv-service-text">
                ...
                <div className="srv-feature-grid">
                  {service.features.map((feat, idx) => (
                    <div key={idx} className="srv-feat-pill">
                      <FaCheckCircle className={`srv-text-${service.gradient}`} /> {feat}
                    </div>
                  ))}
                </div>
             ...
             {/* --- FIXED: EXPLORE BUTTON --- */}
                <div style={{ marginTop: '35px' }}>
                  <Link 
                    to={service.path} 
                    className={`srv-explore-btn srv-text-${service.gradient}`}
                  >
              ...
              <div className="srv-service-img-col">
                <div className="srv-img-frame">
                  ...
                  <div className="srv-service-float-card">
                    ...
                    <div className="srv-card-content">
                      <FaRocket className={`srv-text-${service.gradient}`} style={{fontSize: '2rem'}} />
                      <div>
                        <strong>System Active</strong>
                        <span style={{color: '#4ADE80'}}>Performance: 100%</span>
                      </div>
                    </div>
                  </div>
                </div>
