...
//   // Added name and phone to initial state
//   const [formData, setFormData] = useState({
//     name: '', email: '', phone: '', password: '', city: '', state: '', type: 'Full-Time', areaOfInterest: 'Full-Stack Web Developer'
//   });
...
//       <div className="ept-glass-card" style={{maxWidth: '700px'}}>
//         <h2 className="ept-title">Employee Registration</h2>
//         <p className="ept-subtitle">Join the Lexa Technologies Workforce</p>

//         <form onSubmit={handleSubmit} style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px'}}>
          
//           {/* NEW FIELDS */}
//           <div className="ept-input-group" style={{gridColumn: 'span 2'}}>
//             <label>Full Name</label>
//             <input className="ept-input" name="name" type="text" onChange={handleChange} required placeholder="Ex. Rajesh Kumar" />
//           </div>
...
//           <div className="ept-input-group">
//             <label>City</label>
//             <input className="ept-input" name="city" type="text" onChange={handleChange} required />
//           </div>
//           <div className="ept-input-group">
//             <label>State</label>
//             <input className="ept-input" name="state" type="text" onChange={handleChange} required />
//           </div>

//           <div className="ept-input-group" style={{gridColumn: 'span 2'}}>
//             <label>Area of Interest</label>
//             <select className="ept-input" name="areaOfInterest" onChange={handleChange}>
//               <option>Full-Stack Web Developer</option>
//               <option>Mobile App Developer (Android/iOS)</option>
//               <option>Social Media Content Creator (On-Camera)</option>
//               <option>Video Editor</option>
//               <option>Content Writer / Strategist</option>
...
//           <button className="ept-btn" style={{gridColumn: 'span 2'}}>Register Account</button>
//         </form>
//         <p style={{textAlign: 'center', marginTop: '20px', color: '#94A3B8'}}>
//           Already have an account? <Link to="/portal/login" style={{color: '#06B6D4'}}>Login</Link>
//         </p>
//       </div>
//     </div>
//   );
